        ...
        <div className="overlay">
          <div className="content">
            ...
            <p className="subtitle">
              Utilizing cutting-edge AI technology for early detection of Colon
              Cancer. Early diagnosis can lead to better treatment outcomes.
              Stay ahead with our powerful detection tools, and protect your
              health with precision medicine.
            </p>
            {/* <img
              src={brainTumorImage}
              alt="Brain Tumor"
